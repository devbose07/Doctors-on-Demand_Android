...
public class Consts {
  public static final String APP_ID = "26488";
   public static final String AUTH_KEY = "3JPMaCYJ5rgjV2U";
    public static final String AUTH_SECRET = "VqQMaAZpdHVLyMX";



    public static  String qb_loginID;
    public static final String qb_password="12345678";
    

  public static final Integer second_user_id=7541489;// testuser2>
    public static ArrayList<Integer>  second_user_id_list=new ArrayList<Integer>();
