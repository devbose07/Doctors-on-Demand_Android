...
public class Exercise1E extends Activity 
{
	...
	private void InitUI()
	{
		...
		header.setText("EXERSISE 1E");
		question=(TextView)findViewById(R.id.question);
		question.setText(AppData.exercise_1e);
		...
		ans1.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1e="Not at all";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("5");
				model.setAnswer("1");
				PsychologyData.exerciseListType1.add(model);
				Intent intent = new Intent(getApplicationContext(),Exercise1F.class);
		...
		ans2.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1e="Several days";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("5");
				model.setAnswer("2");
				PsychologyData.exerciseListType1.add(model);
		...
		ans3.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1e="More than half the day";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("5");
				model.setAnswer("3");
				PsychologyData.exerciseListType1.add(model);
		...
		ans4.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1e="Nearly everyday";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("5");
				model.setAnswer("4");
				PsychologyData.exerciseListType1.add(model);
