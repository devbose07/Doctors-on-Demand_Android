...
public class Exercise2F extends Activity 
{
	...
	private void InitUI()
	{
		...
		header.setText("EXERSISE 2F");
		question=(TextView)findViewById(R.id.question);
		question.setText(AppData.exercise_2f);
		...
		ans1.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2f="Not at all";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("6");
				model.setAnswer("1");
				PsychologyData.exerciseListType2.add(model);
				Intent intent = new Intent(getApplicationContext(),Exercise2G.class);
		...
		ans2.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2f="Several days";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("6");
				model.setAnswer("2");
				PsychologyData.exerciseListType2.add(model);
		...
		ans3.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2f="More than half the day";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("6");
				model.setAnswer("3");
				PsychologyData.exerciseListType2.add(model);
		...
		ans4.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2f="Nearly everyday";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("6");
				model.setAnswer("4");
				PsychologyData.exerciseListType2.add(model);
