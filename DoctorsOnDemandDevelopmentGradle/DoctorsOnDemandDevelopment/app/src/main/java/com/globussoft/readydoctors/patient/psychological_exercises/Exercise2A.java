...
public class Exercise2A extends Activity 
{
	...
	private void InitUI()
	{
		...
		header.setText("EXERSISE 2A");
		question=(TextView)findViewById(R.id.question);
		question.setText(AppData.exercise_2a);
		...
		ans1.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2a="Not at all";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("1");
				model.setAnswer("1");
				PsychologyData.exerciseListType2.add(model);
				Intent intent = new Intent(getApplicationContext(),Exercise2B.class);
		...
		ans2.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2a="Several days";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("1");
				model.setAnswer("2");
				PsychologyData.exerciseListType2.add(model);
		...
		ans3.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2a="More than half the day";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("1");
				model.setAnswer("3");
				PsychologyData.exerciseListType2.add(model);
		...
		ans4.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2a="Nearly everyday";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("1");
				model.setAnswer("4");
				PsychologyData.exerciseListType2.add(model);
