...
public class Exercise1C extends Activity 
{
	...
	private void InitUI()
	{
		...
		header.setText("EXERSISE 1C");
		question=(TextView)findViewById(R.id.question);
		question.setText(AppData.exercise_1c);
		...
		ans1.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1c="Not at all";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("3");
				model.setAnswer("1");
				PsychologyData.exerciseListType1.add(model);
				Intent intent = new Intent(getApplicationContext(),Exercise1D.class);
		...
		ans2.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1c="Several days";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("3");
				model.setAnswer("2");
				PsychologyData.exerciseListType1.add(model);
		...
		ans3.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1c="More than half the day";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("3");
				model.setAnswer("3");
				PsychologyData.exerciseListType1.add(model);
		...
		ans4.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1c="Nearly everyday";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("3");
				model.setAnswer("4");
				PsychologyData.exerciseListType1.add(model);
