...
public class Exercise1B extends Activity 
{
	...
	private void InitUI()
	{
		...
		header.setText("EXERSISE 1B");
		question=(TextView)findViewById(R.id.question);
		question.setText(AppData.exercise_1b);
		...
		ans1.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1b="Not at all";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("2");
				model.setAnswer("1");
				PsychologyData.exerciseListType1.add(model);
				Intent intent = new Intent(getApplicationContext(),Exercise1C.class);
		...
		ans2.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1b="Several days";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("2");
				model.setAnswer("2");
				PsychologyData.exerciseListType1.add(model);
		...
		ans3.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1b="More than half the day";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("2");
				model.setAnswer("3");
				PsychologyData.exerciseListType1.add(model);
		...
		ans4.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1b="Nearly everyday";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("2");
				model.setAnswer("4");
				PsychologyData.exerciseListType1.add(model);
