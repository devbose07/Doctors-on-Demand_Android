...
public class MedicalCalender extends Activity
{
	ImageView backImage;
	CalendarView cal;
	ListView list,list2;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if(new ConnectionDetector(getApplicationContext()).isConnectingToInternet())
		{
			...
			if(MedicalData.medicalScheduleType==1)
			{
				...
				getSchedule(MedicalData.doctor_id);
			}
			else
			{
		...
		{
			Toast.makeText(MedicalCalender.this, "You dont have Internet Connection....!", Toast.LENGTH_SHORT).show();
		}
	...
	{
		new VeryLongAsyncTask(MedicalCalender.this).execute();
	}
...
//		local_time="2015/12/02 "+local_time;
	...
	void InitUi()
	{
		...
		list.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id)
			{
				...
				MedicalData.appointment_start_time = appointment_start_time + " " + Singleton.Startdate + ":00";
				MedicalData.appointment_end_time = appointment_end_time + " " + Singleton.Enddate + ":00";
				System.out.println("final "+MedicalData.appointment_start_time + " I  "+ MedicalData.appointment_end_time);
				try
				{
					MedicalData.appointment_start_time=ConvertLocalToUtc(MedicalData.appointment_start_time);
					MedicalData.appointment_end_time=ConvertLocalToUtc(MedicalData.appointment_end_time);
					System.out.println("final in UTC "+MedicalData.appointment_start_time + " I  "+ MedicalData.appointment_end_time);
				}
	...
	public void setupList(final ArrayList<Date> tempList)
	{
		...
		for(int i=0;i<tempList.size();i++)
		{
			...
			else
			{
				...
				Toast.makeText(MedicalCalender.this, "no schedules available....!", Toast.LENGTH_SHORT).show();
			}
		}
	...
	private void getSchedule(final String doctorId)
	{
		...
		RequestQueue queue = Volley.newRequestQueue(MedicalCalender.this);
