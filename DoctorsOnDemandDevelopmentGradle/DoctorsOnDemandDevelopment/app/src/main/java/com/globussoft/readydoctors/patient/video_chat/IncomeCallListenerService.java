...
public class IncomeCallListenerService extends Service implements QBRTCClientSessionCallbacks, QBRTCClientConnectionCallbacks {
    ...
    public void onCreate()
    {
        ...
        System.out.println("D O D Video Chat Service Started");
    ...
    private Notification createNotification()
    {
        ...
        notificationBuilder.setSmallIcon(R.drawable.alert_dark_frame)
                .setContentIntent(contentIntent)
                .setTicker(getResources().getString(R.string.cancel))
                .setWhen(System.currentTimeMillis())
                .setContentTitle(getResources().getString(R.string.cancel))
                .setContentText(getResources().getString(R.string.cancel) + " " +
    ...
    private void createSession(final String login, final String password)
    {
        if (!TextUtils.isEmpty(login) && !TextUtils.isEmpty(password))
        {
            ...
            System.out.println("QBuser create session");
                ...
                public void onSuccess(QBSession session, Bundle bundle)
                {
                    ...
                    else
                    {
                        ...
                        chatService.login(user, new QBEntityCallbackImpl<QBUser>()
                        {
                            ...
                            {
                                Log.d(TAG, "startActionsOnSuccessLogin");
                                startActionsOnSuccessLogin(login, password);
                            }
    ...
    private void startActionsOnSuccessLogin(String login, String password) {
        ...
        System.out.print("####startActionsOnSuccessLogin");
        initQBRTCClient();
