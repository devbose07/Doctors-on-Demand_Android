 ...
 */
public class SeeDoctorSearchPharmacy extends Activity
{
    ...
    public void initUI()
    {
        ...
        search_nearby_me.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Intent intent = new Intent(getApplicationContext(),SeeDoctorLocationActivity.class);
    ...
    {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SeeDoctorSearchPharmacy.this);
        ...
        alertDialog.setPositiveButton("Enable", new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                SeeDoctorSearchPharmacy.this.startActivity(intent);
            }
        });
    ...
    public void validateInputs()
    {
        ...
        if(zipcode.getText().toString().length()>0||name.getText().toString().length()>0||phone.getText().toString().length()>0)
        {
            ...
            {
                Toast.makeText(SeeDoctorSearchPharmacy.this, "You dont have Internet Connection....!", Toast.LENGTH_SHORT).show();
            }
    ...
    public void onBackPressed()
    {
        ...
        startActivity(intent);
        SeeDoctorSearchPharmacy.this.finish();
    }
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        try {
                            ...
                            if (json.getString("code").equals("200"))
                            {
                                ...
                                SeeDoctorSearchPharmacyResult.searchList.clear();
                                for (int i=0;i<array.length();i++)
                                {
                                    ...
                                    SeeDoctorSearchPharmacyResult.searchList.add(model);
                                ...
                                if(SeeDoctorSearchPharmacyResult.searchList.size()>0)
                                {
                                    progressBar.setVisibility(View.INVISIBLE);
                                    Intent intent = new Intent(getApplicationContext(),SeeDoctorSearchPharmacyResult.class);
                                    startActivity(intent);
                                }
                                else
                                {
                                    progressBar.setVisibility(View.INVISIBLE);
                                    Toast.makeText(SeeDoctorSearchPharmacy.this, "No details found for the given search details, Try again", Toast.LENGTH_SHORT).show();
                                }
                            }
                            else
                            {
