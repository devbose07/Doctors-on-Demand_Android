 ...
 */
public class ScreeningTrainingPsychology extends Activity
{
    ImageView backImage;
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.screening_training_psychologists);
        initUI();
    }
    public void initUI()
    {
    ...
    public void onBackPressed()
    {
        ...
        ScreeningTrainingPsychology.this.finish();
    }
}