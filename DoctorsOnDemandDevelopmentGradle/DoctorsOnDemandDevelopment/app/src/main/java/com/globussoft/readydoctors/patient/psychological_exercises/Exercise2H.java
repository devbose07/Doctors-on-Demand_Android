...
public class Exercise2H extends Activity 
{
	...
	private void InitUI()
	{
		...
		header.setText("EXERSISE 2H");
		question=(TextView)findViewById(R.id.question);
		question.setText(AppData.exercise_2h);
		...
		ans1.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2h="Not at all";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("8");
				model.setAnswer("1");
				PsychologyData.exerciseListType2.add(model);
				Intent intent = new Intent(getApplicationContext(),Exercise2I.class);
		...
		ans2.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2h="Several days";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("8");
				model.setAnswer("2");
				PsychologyData.exerciseListType2.add(model);
		...
		ans3.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2h="More than half the day";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("8");
				model.setAnswer("3");
				PsychologyData.exerciseListType2.add(model);
		...
		ans4.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2h="Nearly everyday";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("8");
				model.setAnswer("4");
				PsychologyData.exerciseListType2.add(model);
