                                ...
                                else
                                {
                                    for(int i=0;i<searchList.size();i++)
                                    {
                                       ...
                                       /* Bitmap.Config conf = Bitmap.Config.ARGB_8888;
                                        Bitmap bmp = Bitmap.createBitmap(400, 50, conf);
...
//                                        paint.setTypeface(tf);
                                        ...
                                        paint.getTextBounds(searchList.get(i).getPharmacyName(), 0, searchList.get(i).getPharmacyName().length(), textRect);
...
//                                        Canvas canvas = new Canvas(bmp);
                                        ...
                                        canvas.drawText(searchList.get(i).getPharmacyName(), 0, 50, paint); // paint defines the text color, stroke width, size
...
//                                        Toast.makeText(LocationActivity.this, json.getString("message"), Toast.LENGTH_SHORT).show();
    ...
    public void onLocationChanged(Location location) 
    {
       ...
       /* LatLng pradeep = new LatLng(21.2101582, 81.3234275);
        addMarker(pradeep,"pradeep");

        LatLng partha = new LatLng(21.2131338, 81.3236635);

        addMarker(partha, "partha");*/
