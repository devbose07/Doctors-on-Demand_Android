...
public class Exercise2C extends Activity 
{
	...
	private void InitUI()
	{
		...
		header.setText("EXERSISE 2C");
		question=(TextView)findViewById(R.id.question);
		question.setText(AppData.exercise_2c);
		...
		ans1.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2c="Not at all";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("3");
				model.setAnswer("1");
				PsychologyData.exerciseListType2.add(model);
				Intent intent = new Intent(getApplicationContext(),Exercise2D.class);
		...
		ans2.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2c="Several days";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("3");
				model.setAnswer("2");
				PsychologyData.exerciseListType2.add(model);
		...
		ans3.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2c="More than half the day";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("3");
				model.setAnswer("3");
				PsychologyData.exerciseListType2.add(model);
		...
		ans4.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2c="Nearly everyday";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("3");
				model.setAnswer("4");
				PsychologyData.exerciseListType2.add(model);
