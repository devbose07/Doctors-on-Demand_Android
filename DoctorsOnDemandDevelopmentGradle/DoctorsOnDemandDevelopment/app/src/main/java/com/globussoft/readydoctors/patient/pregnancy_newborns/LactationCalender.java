...
public class LactationCalender extends Activity
{
	ImageView backImage;
	CalendarView cal;
	ListView list,list2;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if(new ConnectionDetector(getApplicationContext()).isConnectingToInternet())
		{
			...
			if(LactationData.LactationScheduleType==1)
			{
				...
				getSchedule(LactationData.doctor_id);
			}
			else
			{
		...
		{
			Toast.makeText(LactationCalender.this, "You dont have Internet Connection....!", Toast.LENGTH_SHORT).show();
		}
	...
	{
		new VeryLongAsyncTask(LactationCalender.this).execute();
	}
...
//				LactationData.time_period = "30";
				...
				LactationData.appointment_start_time = appointment_start_time + " " + Singleton.Startdate + ":00";
				LactationData.appointment_end_time = appointment_end_time + " " + Singleton.Enddate + ":00";
				System.out.println("final "+LactationData.appointment_start_time + " I  "+ LactationData.appointment_end_time);
				try
				{
					LactationData.appointment_start_time=ConvertLocalToUtc(LactationData.appointment_start_time);
					LactationData.appointment_end_time=ConvertLocalToUtc(LactationData.appointment_end_time);
					System.out.println("final in UTC "+LactationData.appointment_start_time + " I  "+ LactationData.appointment_end_time);
				}
...
//					LactationData.time_period = "30";
	...
	public void setupList(final ArrayList<Date> tempList)
	{
		...
		for(int i=0;i<tempList.size();i++)
		{
			...
			else
			{
				...
				Toast.makeText(LactationCalender.this, "No schedules available....!", Toast.LENGTH_SHORT).show();
			}
		}
	...
	private void getSchedule(final String doctorId)
	{
		...
		RequestQueue queue = Volley.newRequestQueue(LactationCalender.this);
