...
/**
 * Created by GLB-276 on 12/8/2015.
 */
public class MedicalScheme extends Activity
{
    ...
    private void initUI()
    {
        ...
        {
            Toast.makeText(MedicalScheme.this, "You dont have Internet Connection....!", Toast.LENGTH_SHORT).show();
        }

        title=(TextView)findViewById(R.id.edittext);
        title.setText("APPOINTMENT DURATION");
        header=(TextView)findViewById(R.id.textView1);
        header.setText("How long whould you like to meet with your medical Doctor ?");
...
//        schemeBTxt.setText(cost2);
        ...
        schemeA.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if(gotCost)
                {
                    MedicalData.callcost=callcost1;
                    MedicalData.calltime=calltime1;
                    AppData.scheduleTiming=Integer.parseInt(MedicalData.calltime);
                    MedicalData.creditremains=creditremains1;
                    MedicalData.needtopay=needtopay1;
                    MedicalData.planid=planid1;
                    Intent intent = new Intent(getApplicationContext(),MedicalCalender.class);
        ...
        schemeB.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                MedicalData.callcost=callcost2;
                MedicalData.calltime=calltime2;
                AppData.scheduleTiming=Integer.parseInt(MedicalData.calltime);
                MedicalData.creditremains=creditremains2;
                MedicalData.needtopay=needtopay2;
                MedicalData.planid=planid2;
                Intent intent = new Intent(getApplicationContext(),MedicalCalender.class);
                startActivity(intent);
            }
        });
    ...
    {
        RequestQueue queue = Volley.newRequestQueue(MedicalScheme.this);
