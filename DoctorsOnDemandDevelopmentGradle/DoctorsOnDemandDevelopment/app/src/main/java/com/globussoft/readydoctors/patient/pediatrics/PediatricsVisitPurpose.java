...
public class PediatricsVisitPurpose extends Activity 
{
	...
	private void InitUI(){
		...
		next_btn.setOnClickListener(new OnClickListener() 
		{
			...
			public void onClick(View v) 
			{
				...
				{
					PediatricData.purpose=editbox.getText().toString();
					Intent intent=new Intent(getApplicationContext(),PediatricsTimePeriod.class);
