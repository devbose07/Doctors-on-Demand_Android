...
public class PediatricsCalendar extends Activity
{
	ImageView backImage;
	CalendarView cal;
	ListView list,list2;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if(new ConnectionDetector(getApplicationContext()).isConnectingToInternet())
		{
			...
			if(PediatricData.pediatricsScheduleType==1)
			{
				...
				getSchedule(PediatricData.doctor_id);
			}
			else
			{
		...
		{
			Toast.makeText(PediatricsCalendar.this, "You dont have Internet Connection....!", Toast.LENGTH_SHORT).show();
		}
	...
	{
		new VeryLongAsyncTask(PediatricsCalendar.this).execute();
	}
...
//		local_time="2015/12/02 "+local_time;
	...
	void InitUi()
	{
		...
		list.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id)
			{
				...
				MedicalData.time_period = "30";

				Singleton.Startdate = scheduleList.get(position1).getTime();
				Singleton.Enddate = scheduleList.get(position1).getTimelimit();

				PediatricData.appointment_start_time = appointment_start_time + " " + Singleton.Startdate + ":00";
				PediatricData.appointment_end_time = appointment_end_time + " " + Singleton.Enddate + ":00";
				System.out.println("final "+PediatricData.appointment_start_time + " I  "+ PediatricData.appointment_end_time);
				try
				{
					PediatricData.appointment_start_time=ConvertLocalToUtc(PediatricData.appointment_start_time);
					PediatricData.appointment_end_time=ConvertLocalToUtc(PediatricData.appointment_end_time);
					System.out.println("final in UTC "+PediatricData.appointment_start_time + " I  "+ PediatricData.appointment_end_time);
				}
	...
	public void setupList(final ArrayList<Date> tempList)
	{
		...
		for(int i=0;i<tempList.size();i++)
		{
			...
			else
			{
				...
				Toast.makeText(PediatricsCalendar.this, "no schedules available....!", Toast.LENGTH_SHORT).show();
			}
		}
	...
	private void getSchedule(final String doctorId)
	{
		...
		RequestQueue queue = Volley.newRequestQueue(PediatricsCalendar.this);
