...
public class Exercise2D extends Activity 
{
	...
	private void InitUI()
	{
		...
		header.setText("EXERSISE 2D");
		question=(TextView)findViewById(R.id.question);
		question.setText(AppData.exercise_2d);
		...
		ans1.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2d="Not at all";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("4");
				model.setAnswer("1");
				PsychologyData.exerciseListType2.add(model);
				Intent intent = new Intent(getApplicationContext(),Exercise2E.class);
		...
		ans2.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2d="Several days";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("4");
				model.setAnswer("2");
				PsychologyData.exerciseListType2.add(model);
		...
		ans3.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2d="More than half the day";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("4");
				model.setAnswer("3");
				PsychologyData.exerciseListType2.add(model);
		...
		ans4.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2d="Nearly everyday";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("4");
				model.setAnswer("4");
				PsychologyData.exerciseListType2.add(model);
