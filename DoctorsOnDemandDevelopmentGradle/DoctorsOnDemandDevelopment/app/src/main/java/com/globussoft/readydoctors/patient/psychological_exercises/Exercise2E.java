...
public class Exercise2E extends Activity 
{
	...
	private void InitUI()
	{
		...
		header.setText("EXERSISE 2E");
		question=(TextView)findViewById(R.id.question);
		question.setText(AppData.exercise_2e);
		...
		ans1.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2e="Not at all";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("5");
				model.setAnswer("1");
				PsychologyData.exerciseListType2.add(model);
				Intent intent = new Intent(getApplicationContext(),Exercise2F.class);
		...
		ans2.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2e="Several days";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("5");
				model.setAnswer("2");
				PsychologyData.exerciseListType2.add(model);
		...
		ans3.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2e="More than half the day";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("5");
				model.setAnswer("3");
				PsychologyData.exerciseListType2.add(model);
		...
		ans4.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_2e="Nearly everyday";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("5");
				model.setAnswer("4");
				PsychologyData.exerciseListType2.add(model);
