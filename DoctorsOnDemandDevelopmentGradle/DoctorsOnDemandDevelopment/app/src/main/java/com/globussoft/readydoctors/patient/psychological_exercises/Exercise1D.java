...
public class Exercise1D extends Activity 
{
	...
	private void InitUI()
	{
		...
		header.setText("EXERSISE 1D");
		question=(TextView)findViewById(R.id.question);
		question.setText(AppData.exercise_1d);
		...
		ans1.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1d="Not at all";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("4");
				model.setAnswer("1");
				PsychologyData.exerciseListType1.add(model);
				Intent intent = new Intent(getApplicationContext(),Exercise1E.class);
		...
		ans2.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1d="Several days";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("4");
				model.setAnswer("2");
				PsychologyData.exerciseListType1.add(model);
		...
		ans3.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1d="More than half the day";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("4");
				model.setAnswer("3");
				PsychologyData.exerciseListType1.add(model);
		...
		ans4.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				PsychologyData.exercise_1d="Nearly everyday";
				ExerciseModel model=new ExerciseModel();
				model.setQuestion("4");
				model.setAnswer("4");
				PsychologyData.exerciseListType1.add(model);
